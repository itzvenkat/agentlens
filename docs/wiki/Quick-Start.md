...
This starts **5 services**: PostgreSQL, Redis, API (`:9471`), Dashboard (`:9472`), and LLM Proxy (`:9473`).
...
Go to [http://localhost:9472](http://localhost:9472). You'll see the analytics dashboard (empty for now).
...
- **[[LLM Proxy]]** — Point your desktop app (Claude, Cursor) at `localhost:9473`. Zero code.
